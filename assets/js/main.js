(function ($) {
  ...
  */
  ...
  try {
    ...
    var discordButton = document.getElementsByClassName("access-modal-content")[0];
    var accessBtn = document.getElementById("accessAppButton");
    var accessSpan = document.getElementsByClassName("close")[0];
    accessBtn.onclick = function () {
      //$(".cs-munu_toggle").toggleClass("cs-toggle_active").siblings(".cs-nav_list").slideToggle();
  ...
  function mainNav() {
    ...
    $(".menu-item-has-children").append('<span class="cs-munu_dropdown_toggle"></span>');
  ...
  function modalVideo() {
    $(document).on("click", ".cs-video_open", function (e) {
      ...
      $(".cs-video_popup_container iframe").attr("src", `https://www.youtube.com/embed/${video}`);
  ...
  function accordian() {
    ...
    $(".cs-accordian_head").on("click", function () {
      $(this).parent(".cs-accordian").siblings().children(".cs-accordian_body").slideUp(250);
      $(this).siblings().slideDown(250);
      $(this).parent().parent().siblings().find(".cs-accordian_body").slideUp(250);
        ...
        on: {
          ...
          progress: function (swiper) {
            for (let i = 0; i < swiper.slides.length; i++) {
              ...
              swiper.slides[i].querySelector(".cs-swiper_parallax_bg").style.transform = "translateX(" + innerTranslate + "px)";
            }
          },
          ...
          setTransition: function (swiper, transition) {
            for (let i = 0; i < swiper.slides.length; i++) {
              ...
              swiper.slides[i].querySelector(".cs-swiper_parallax_bg").style.transition = transition + "ms";
            }
          },
        },
      };
